...
import { Button, Fieldset, TextInput, Checkbox, Collapse } from '@mantine/core';
...
export default function SocialProvider({ csrfToken }: any = {}) {
  ...
  return (
    <Fieldset legend="Verify your identity via social service:" className={styles.fieldset}>
      ...
      <form
        ...
        onSubmit={async (e) => {
          ...
          //   }
          // }
          makeToast({ title: 'Not finished yet. Please check back.', type: 'error' });
        }}
      >
        {!!errorMessage && (
        ...
        <div className={styles.fieldsetStep} data-state={!email ? 'disabled' : 'active'}>
          <Checkbox
        ...
        >
          <p className="text-stone-500 text-sm pt-4 pb-3">
            <FontAwesomeIcon icon={faCircleInfo} /> &nbsp;Learn how this connects to your account
          </p>
        </Collapse>
        <Collapse
          in={infoOpened}
        ...
        >
          ...
          <p className="text-stone-500 text-[1rem] pt-5 pb-4 text-center">
            If you already have an account with same email as this social provider, this will sign
            in to your existing account.
          </p>
          <p className="text-stone-500 text-[1rem] pt-5 pb-4 text-center">
            If you already have an account with PHONE (no email), then this will create a new
            account. INSTEAD, PLEASE login with phone and go to your account profile to add a Social
            Provider.
          </p>
          <p className="text-stone-500 text-[1rem] pt-5 pb-4 text-center">
            We will never be able to view your social media content or post on your profile.
          </p>
        </Collapse>
      </form>
    </Fieldset>
