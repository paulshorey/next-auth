...
export default function phoneOrEmail(string: string) {
  let error = 'Invalid phone or email format. Should be: +1 555 555-5555 or hey@example.com';
  let errorEmail = 'Invalid email format. Should be: hey@example.com';
  let errorPhone = 'Invalid phone number. Should be: +1 555 555-5555';
